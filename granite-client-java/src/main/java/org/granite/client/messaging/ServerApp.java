...
/**
 * Simple server application definition holding basic network parameters (server name, port, context root) It can be used to create channels when you don't exactly know how the
 * final URI should look like The channel builder for the requested channel type will then build the correct URI using the server app parameters
 *
