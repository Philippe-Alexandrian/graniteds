...
public interface ResponseMessageFuture {
    ...
    /**
     * Wait synchronously for the response. This method throws a TimeoutException if the specified amount of time ({@code timeout}) has elapsed before the response is received. If
     * {@code timeout} is zero, however, then the method simply waits until the response is received or the default transport timeout has elapsed.
     *
